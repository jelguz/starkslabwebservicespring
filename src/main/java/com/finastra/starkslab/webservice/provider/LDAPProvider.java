...
public class LDAPProvider {
    ...
    public User validateLogin(String id, String userPassword) {
        ...
        env.put(Context.SECURITY_PRINCIPAL, "email"); /// Change this to your email e.g. hommer.mallari@misys.com
        env.put(Context.SECURITY_CREDENTIALS, "password");   ///Change this to your LAN/windows password
